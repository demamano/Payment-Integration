        ...
        switch (_context.prev = _context.next) {
          case 0:
            schema = object().shape({
              ...
              customization: object().shape({
                title: string().optional(),
                description: string().optional(),
                logo: string().optional()
              }).optional(),
              subaccounts: object().shape({
                id: string().required(),
                split_type: string().optional(),
                transaction_charge: string().optional()
              }).optional()
            });
            _context.next = 3;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            schema = object().shape({
              ...
              split_type: mixed().oneOf(Object.values(SplitType)).required(),
              split_value: number().required()
            });
            _context.next = 3;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              _context.next = 5;
              return axios.post(ChapaUrls.INITIALIZE, initializeOptions, {
                headers: {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              _context2.next = 5;
              return axios.get(ChapaUrls.VERIFY + "/" + verifyOptions.tx_ref, {
                headers: {
                  Authorization: "Bearer " + this.chapaOptions.secretKey
                }
              });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              nanoid = customAlphabet(alphanumeric, size);
              _context3.next = 5;
              return nanoid();
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return axios.get(ChapaUrls.BANKS, {
                headers: {
                  Authorization: "Bearer " + this.chapaOptions.secretKey
                }
              });
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              _context5.next = 5;
              return axios.post(ChapaUrls.SUBACCOUNT, createSubaccountOptions, {
                headers: {
                  Authorization: "Bearer " + this.chapaOptions.secretKey
                }
              });
...
export { Chapa, ChapaUrls, SplitType };
//# sourceMappingURL=chapa-nodejs.esm.js.map
